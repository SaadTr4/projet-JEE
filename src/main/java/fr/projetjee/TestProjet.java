...
public class TestProjet {
    ...
    private void run() {
        try {
            ...
            User user1 = userDAO.save(new User("EMP001", "Dupont", "Jean", "jean.dupont@entreprise.fr"));
            ...
            User user2 = userDAO.save(new User("EMP002", "Martin", "Sophie", "sophie.martin@entreprise.fr"));
            ...
            User user3 = userDAO.save(new User("EMP003", "Bernard", "Luc", "luc.bernard@entreprise.fr"));
            ...
            User user4 = userDAO.save(new User("EMP004", "Lefevre", "Marie", "marie.lefevre@entreprise.fr"));
            ...
            User user5 = userDAO.save(new User("EMP005", "Moreau", "Pierre", "pierre.moreau@entreprise.fr"));
            ...
            User user6 = userDAO.save(new User("EMP006", "Petit", "Claire", "claire.petit@entreprise.fr"));
            ...
            Project project1 = projectDAO.save(new Project("Refonte Site Web", user1, "Refonte complète du site web avec React et Spring Boot", Status.IN_PROGRESS));
            Project project2 = projectDAO.save(new Project("Application Mobile", user2, "Développement d'une app mobile iOS et Android", Status.IN_PROGRESS));
            Project project3 = projectDAO.save(new Project("Migration Cloud", user3, "Migration de l’infrastructure vers AWS", Status.COMPLETED));
            Project project4 = projectDAO.save(new Project("ERP Interne", user4, "Mise en place d’un ERP interne", Status.CANCELLED));
            Project project5 = projectDAO.save(new Project("API Gateway", user1, "Développement d’une API Gateway centralisée", Status.IN_PROGRESS));
            ...
            // assignUserToProject
            boolean assigned1 = projectDAO.assignUserToProject(project3.getId(), "EMP005");
            boolean assigned2 = projectDAO.assignUserToProject(project2.getId(), "EMP002");

            System.out.println("Assignation EMP005 au projet " + project3.getName() + ": " + (assigned1 ? "✅ OK" : "❌ Échec"));
            ...
            boolean deletedPayslip = payslipDAO.delete(user1Payslips.get(0).getId());
            System.out.println("Suppression fiche de paie ID=" + user1Payslips.get(0).getId() + ": " + (deletedPayslip ? "✅ OK" : "❌ Échec"));
