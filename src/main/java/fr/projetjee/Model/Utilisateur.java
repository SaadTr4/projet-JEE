...
public class Utilisateur implements Serializable {
    ...
    public Utilisateur(String matricule, String lastName, String firstName, String email) {
    ...
    public fr.projetjee.Model.Position getPosition() {
        return position;
    }
    
    public void setPosition(fr.projetjee.Model.Position position) {
