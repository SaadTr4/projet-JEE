...
public class TestPayslip {
    ...
    void initDAO() {
        ...
        // ---------------------
        user1 = new User("EMP200_TEST", "DurandTest", "Paul", "paul.durandTest@entreprise.fr");
        user1.setPassword("test123");
        user1.setGrade(Grade.SENIOR);
        user1.setRole(Role.EMPLOYE);
        userDAO.save(user1);

        user2 = new User("EMP201_TEST", "BernardTest", "Lucie", "lucie.bernardTest@entreprise.fr");
        ...
        // ---------------------
        payslip1 = new Payslip(2024,5, new BigDecimal("3000.00"), new BigDecimal("350.00"), new BigDecimal("750.00"), user1);
        payslipDAO.save(payslip1);

        payslip2 = new Payslip(2024,6, new BigDecimal("3200.00"), new BigDecimal("400.00"), new BigDecimal("800.00"), user1);
    ...
    void testSavePayslip_success() {
        Payslip p = new Payslip(2024, 10, new BigDecimal("4500.00"), new BigDecimal("500.00"), new BigDecimal("1000.00"), user1);
    ...
    void testUpdatePayslip_nonExisting() {
        Payslip fakeSlip = new Payslip(2023, 1, new BigDecimal("2000.00"), new BigDecimal("200.00"), new BigDecimal("500.00"), user2);
